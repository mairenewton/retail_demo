- dashboard: address_deepdive
  ...
  - name: "<span class='fa fa-map-pin'> Address Overview</span>"
    ...
    body_text: |-
      **Recommended Action 👇**
      Check if the address does not look residential, or has an abnormally high number of registered customers or volume. If so, set up a regular alert to monitor it, and alert the fraud team if the pattern continues 🔔.
    row: 0
    col: 0
    width: 24
    height: 4
