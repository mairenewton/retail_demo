- dashboard: item_affinity_analysis
  ...
  - title: What are my most popular and margin-generating items?
    ...
    explore: order_purchase_affinity
    type: table
    fields: [order_purchase_affinity.product_a, order_purchase_affinity.product_a_image,
      order_purchase_affinity.product_a_average_rest_of_basket_margin, order_purchase_affinity.product_a_order_frequency,
      order_purchase_affinity.product_a_order_count, order_purchase_affinity.product_a_percent_purchased_by_loyalty_customer]
  ...
  - title: What items go well with the focus product and drive the biggest combined
    ...
    explore: order_purchase_affinity
    type: table
    fields: [order_purchase_affinity.product_b, order_purchase_affinity.product_b_image,
      order_purchase_affinity.product_b_average_rest_of_basket_margin, order_purchase_affinity.lift,
      order_purchase_affinity.product_b_order_frequency]
    sorts: [order_purchase_affinity.lift desc]
    limit: 50
    query_timezone: America/Los_Angeles
    show_view_names: false
  ...
  - title: Product Rationalisation
    ...
    type: table
    fields: [order_purchase_affinity.product_a, order_purchase_affinity.product_a_image,
      order_purchase_affinity.product_a_order_frequency, order_purchase_affinity.product_a_average_basket_margin,
      order_purchase_affinity.product_a_percent_purchased_by_loyalty_customer, order_purchase_affinity.product_a_percent_customer_exclusivity]
  ...
  - title: Margin Uplift from Top 5 Promotions in Category
    ...
    dynamic_fields: [{dimension: margin_uplift_from_promotion, label: Margin Uplift
          from Promotion, expression: "(${order_purchase_affinity.product_a_total_margin}+${order_purchase_affinity.product_b_total_basket_margin})*${assumed_promotion_uptake}*(${order_purchase_affinity.lift}-1)",
