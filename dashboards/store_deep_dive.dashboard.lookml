- dashboard: store_deepdive
  ...
  - name: "<span class='fa fa-flag-checkered'> Peer Store Comparison</span>"
    ...
    body_text: |-
      **Recommended Action 👇**
      Text/call high-performing store managers this week to see if they have any advice. Check if different weather trends are affecting your performance as much as in your peer stores.
    row: 2
    col: 0
    width: 24
    height: 4
  - name: "<span class='fa fa-users'> Customer Behaviour</span>"
    ...
    body_text: |-
      **Recommended Action 👇**
      Look for segments with low performance (YoY or vs peer stores), and drill into them to see possible actions to drive them back to our store.
    row: 43
    col: 0
    width: 24
    height: 4
  ...
  - title: How well am I selling products that are doing well in my peer stores?
    ...
    fields: [stores.store_comparison_vs_tier, transactions__line_items.total_quantity_per_store,
      transactions.number_of_transactions_per_store, products.name, products.product_image]
  ...
  - name: "<span class='fa fa-boxes'> Inventory Tracking</span>"
    ...
    body_text: |-
      **Recommended Action 👇**
      Check which products are over/under stocked and make/save money accordingly. Compare to products that are selling better in peer stores, and order them in or drill into their item dynamics to see how to bundle them.
    row: 21
    col: 0
    width: 24
    height: 4
