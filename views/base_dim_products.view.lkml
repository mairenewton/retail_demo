view: products {
  ...
  dimension: category {
    ...
    link: {
      ...
      url: "https:///dashboards/Ipxk660N88jaUxsHolxRts?Focus%20Category={{value | encode_uri}}&Minimum%20Purchase%20Frequency="
    }
    action: {
      ...
      form_param: {
        ...
        label: "Message"
        required: yes
        default: "Hi, can you please check out what's going on in {{rendered_value}}? https:///dashboards/Ipxk660N88jaUxsHolxRts?Category={{value | encode_uri}}"
      }
    }
  }
